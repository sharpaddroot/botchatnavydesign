...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Jan 20, 2020 at 04:24 AM
...
--
-- Dumping data for table `cloud_chat`
--

INSERT INTO `cloud_chat` (`send_id`, `question`, `chat_id`, `time_re`) VALUES
(112, 'สวัสดี', 'f528764d624db129b32c21fbca0cb8d6', 15),
(113, '1อาทิตย์มีกี่วัน', 'f528764d624db129b32c21fbca0cb8d6', 15),
(114, 'ตอบกลับแบบรูปภาพที่1', 'f528764d624db129b32c21fbca0cb8d6', 15),
(115, 'ตอบกลับแบบรูปภาพที่2', 'f528764d624db129b32c21fbca0cb8d6', 15),
(116, 'ตอบกลับแบบปุ่มที่1', 'f528764d624db129b32c21fbca0cb8d6', 15);
...
--
ALTER TABLE `bot_answer`
  MODIFY `answer_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;

--
-- AUTO_INCREMENT for table `button_type`
--
ALTER TABLE `button_type`
  MODIFY `answer_id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `cloud_chat`
--
ALTER TABLE `cloud_chat`
  MODIFY `send_id` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=117;

--
-- AUTO_INCREMENT for table `image_type`
--
ALTER TABLE `image_type`
  MODIFY `answer_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
COMMIT;
